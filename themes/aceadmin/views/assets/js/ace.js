...
jQuery(function(a){
	...
	ace.handle_side_menu=function(a){
		...
		a(".nav-list").on(ace.click_event,function(h){
			...
			if(c&&a(f.parentNode.parentNode).hasClass("nav-list")){return false}
